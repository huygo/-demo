...
public class WechatUser {
	...
	public String toString() {
		return "WechatUser [subscribe=" + subscribe + ", subscribe_time=" + subscribe_time + ", language=" + language
				+ ", remark=" + remark + ", groupid=" + groupid + ", openid=" + openid + ", nickname=" + nickname + ", sex=" + sex
