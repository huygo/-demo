package cn.easier.brow.sys.redis.util;
...
import cn.easier.brow.sys.redis.bean.Pair;
import cn.easier.brow.sys.redis.inte.RedisUtilInte;
 ...
 * @author fengjc
 */
public class RedisUtil implements RedisUtilInte {
	...
	/**
	 * 执行器，{@link com.RedisUtilInte.framework.base.redis.RedisUtil}的辅助类，
